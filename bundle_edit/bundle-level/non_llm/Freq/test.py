...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='clothing1')
    ...
    elif args.dataset == 'clothing1':
        data_dir = '../../data/clothing1/'
    elif args.dataset == 'food1':
        data_dir = '../../data/food1/'
    elif args.dataset == 'electronic1':
        data_dir = '../../data/electronic1/'
    ...
    train_data_list = []
    for i in train_data:
        train_data_list.append(train_data[i])  # ✓ append保持bundle完整
    train_data = train_data_list
