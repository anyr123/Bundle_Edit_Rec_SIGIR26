...
config_args = {
    ...
    'data_config': {
        ...
        'dataPath': ('../editrec_data', 'path of dataset'),
        'log': ('./log', 'log save path '),
        ...
        'conti_train': ('iFashion-simple.pth', 'which sample way to use'),
        'dataset': ('iFashion', 'which dataset to use'),
        ...
        'rho': (0, 'bundle item mask ratio: -4/-2/0/2/4'),
    }
}
