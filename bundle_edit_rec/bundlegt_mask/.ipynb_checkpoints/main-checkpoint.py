...
def get_cmd():
    ...
    parser.add_argument( "--l2_reg", default=1e-05, type=float, help="L2 regularization")
    ...
    parser.add_argument("--rho", default=0, type=int,
                    help="bundle item mask ratio: -4/-2/0/2/4")
...
def main():
    ...
    # model.load_state_dict(torch.load('./bundlegt_youshu'), strict=False)
    ...
    for epoch in range(conf['epochs']):
        ...
        for batch_i, batch in pbar:
            ...
            if (batch_anchor+1) % test_interval_bs == 0:  
                ...
                metrics["test"] = test(model, dataset.test_loader, conf,test=True)
...
def test(model, dataloader, conf,test):
    tmp_metrics = {}
